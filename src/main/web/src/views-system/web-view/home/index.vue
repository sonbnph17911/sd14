      ...
      <el-row :gutter="20">
        ...
        <el-col :span="24">
          <div class="tag-product">
            ...
            <div style="margin-top: 20px;">
              <el-row :gutter="40">
                <el-col v-for="p in listProductTop5" :key="p.id" :span="4" class="image-container" style="cursor: pointer;">
        ...
        <el-col :span="24" style="margin-top: 20px;">
          <div class="tag-product">
            ...
            <div style="margin-top: 20px;">
              <el-row :gutter="40">
                <el-col v-for="p in listProductTop5BestSelling" :key="p.id" :span="4" class="image-container" style="cursor: pointer;">
                  <div @click="toProduct(p.id)">
                    <div>
                      <img
                        :src="p.listImage[0]"
        ...
        <el-col :span="24" style="margin-top: 20px; margin-bottom: 100px;">
          <div class="tag-product">
            ...
            <div style="margin-top: 20px;">
              <el-row :gutter="40">
                <el-col v-for="p in listProduct" :key="p.id" :span="4" class="image-container" style="cursor: pointer; margin-bottom: 40px;">
                  <div @click="toProduct(p.id)">
                    <div>
                      <img
                        :src="p.listImage[0]"
